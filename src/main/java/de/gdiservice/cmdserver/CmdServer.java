...
class CmdServer {
    ...
    static class Result {
        ...
        public String toString() {
            return "Result [exitCode=" + exitCode + ", stdout= \"" + stdout + "\", stderr=\"" + stderr + "\", err=\"" + err + "\"]";
        }
                    ...
                    public void service(Request request, Response response) throws Exception {
                        ...
                        if (tool!=null) {
                            ...
                            if (cmd!=null) {
                                ...
                                result = runProzess(cmd, params);		        	

                            } else {
                                result = new Result("tool not supported");
                            }
                            
                        } else {
                            result = new Result("parameter is missing");
                        }
